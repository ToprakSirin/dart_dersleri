/*
2- Ogrenci isimli sınıff oluşturun. Bu sınıfta ogrencinin idsi ve not değeri tutulmalı . 100 elemanlı bir listede id ve not değerlerini rastgele oluşturarak bu ogrencileri saklayın ve bu ogrencileri yazdıran metotu yazın.
*/
